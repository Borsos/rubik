...
class Visualizer(object):
    ...
    def __init__(self, logger, data, visualizer_attributes):
...
#            raise RubikError("cannot create a {} for {} with shape {}".format(self.__class__.__name__, type(data).__name__, len(data.shape)))
        ...
        self.concrete_visualizer = self.ConcreteVisualizerClass(logger=logger, attributes=visualizer_attributes, data=data)
